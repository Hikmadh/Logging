...
namespace Hikmadh\Log\Services;
...
class Configuration
{
     ...
     * XML path  constants
     */
    private const PATH_API_STATUS = 'hikmadh_log/rest/status';
    private const PATH_API_URLS = 'hikmadh_log/rest/urls';
    private const PATH_ES_STATUS = 'hikmadh_log/es/status';
    private const PATH_GRAPHQL_STATUS = 'hikmadh_log/graphql/status';
    private const PATH_GRAPHQL_HEADER = 'hikmadh_log/graphql/header';
    private const PATH_GRAPHQL_HTTP_METHODS = 'hikmadh_log/graphql/http_methods';
    private const PATH_GRAPHQL_QUERY_TYPE = 'hikmadh_log/graphql/query_type';
    private const PATH_RABBITMQ_STATUS = 'hikmadh_log/rabbitmq/status';
    private const PATH_VARNISH_STATUS = 'hikmadh_log/varnish/status';
    /**#@-*/
